...
enum Constants {
    ...
    static let speakingTimeTargetPercent: Double = 40.0
    static let speakingTimeTargetMinPercent: Double = 10.0
    static let speakingTimeTargetMaxPercent: Double = 90.0
